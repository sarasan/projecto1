 ...
 * ▪ Possua um método para adicionar as viaturas ao array. Não é permitido
 * inserir
 ...
 * ▪ Crie também um método para mostrar as viaturas apesentando no final o total
 * do
 * campo Preco.
 * 3- Crie uma classe TestarViaturas que possua um método main para testar os
 * métodos
 * criados anteriormente recorrendo às caixas de diálogo como no exemplo
 * mostrado na
 * aula.
 */
